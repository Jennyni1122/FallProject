...
public class AddDeviceUserInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void  sendquest_saveData() {
        ...
        String url = Constant.BASE_WEBSITE + Constant.REQUEST_SETUP_DEVICE_URL+"/account/" + currentDevCode +
                "/cardid/" + currentDevPsw +"dname"+dname+"/sex/"+issex+"/idcard/"+idcard+"/guardian/"+spUserPhone+
                "/isgeo/"+isgeo+ "/geocenter/"+geocenter+"/georadius/"+georadius;
